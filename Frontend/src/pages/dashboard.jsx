...
>
              ...
              {showProfileMenu && (
                ...
                >
                  ...
                  {/* Menu */}
                  <button onClick={() => navigate("/dashboard/profile")} className="dash-btn-ghost">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
                    <circle cx="12" cy="7" r="4"/>
                  </svg> My Profile</button>

                  <button onClick={() => navigate("/dashboard/settings")} className="dash-btn-ghost">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <button onClick={() => navigate("/dashboard/saved")} className="dash-btn-ghost">
